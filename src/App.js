...
export default function App() {
    ...
    return (
        <AuthProvider>
            <div className={`min-h-screen font-sans bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300`}>
...
const AppContent = ({ darkMode, toggleDarkMode }) => {
    ...
    return (
        <>
            <Header darkMode={darkMode} setDarkMode={toggleDarkMode} onSignOut={handleSignOut} showSignOut={!!user || isGuest} />
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center mt-16 sm:mt-24">
            <div className="max-w-md w-full p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">Welcome to PreHealthFolio</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-6">Your personal logbook for tracking clinical and non-clinical hours on your journey to professional school.</p>
                <div className="space-y-4">
                    <button onClick={handleSignIn} className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg shadow-md transition-transform transform hover:scale-105 duration-300">
                    ...
                    <button onClick={onGuestLogin} className="w-full bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-4 rounded-lg shadow-md transition-transform transform hover:scale-105 duration-300">
                        Continue as Guest
                    </button>
                </div>
            </div>
